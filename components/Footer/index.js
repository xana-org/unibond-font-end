        ...
        <Box w="100%" color="#FFF" mt="auto" bottom={0} bg="#24252c" zIndex={10}>
            <Flex maxW="80rem" w="100%"  flexDirection="row" justifyContent="center">
                ...
                <Flex w="25%" m="0 auto"  p="1rem 1rem"  flexDirection="column" >
                    <Text fontSize="18px" fontWeight="bold" m="auto 0rem auto 0" cursor="pointer" textAlign="right" color="#FFF" transition="0.2s">ABOUT ZORACLES.</Text>
                ...
                <Flex flexDirection="column"  p="1rem 1rem">
                    ...
                    <Link href="/explore">
                        <Text fontSize="14px" fontWeight="500" m="auto 2rem auto 0" cursor="pointer" _hover={{color:"#0E0F11"}} color="#FFF" transition="0.2s">Uni</Text>
                    </Link>
                    <Link href="/mypositions">
                        <Text fontSize="14px" fontWeight="500" m="auto 2rem auto 0" cursor="pointer" _hover={{color:"#0E0F11"}} color="#FFF" transition="0.2s">My NFTs</Text>
                    </Link>
                    <Link href="/salelist">
                        <Text fontSize="14px" fontWeight="500" m="auto 2rem auto 0" cursor="pointer" _hover={{color:"#0E0F11"}} color="#FFF" transition="0.2s">Bond Sale</Text>
                    </Link>
                </Flex>
