...
const Home = () => {
  ...
  return (
    <Box w="100%" m="10rem 0 8rem 0rem" color="#0E0E0E">
      <Flex maxW="80rem" w="100%" height="auto" m="3rem auto" p="0 1rem" flexDirection="column">
        ...
        <Flex flexDirection={["column", "column", "column", "row"]} mb="150px">
          ...
          <Flex w={["100%", "100%", "100%", "40%"]} ml={[0, 0, 0, "5%"]} mt={["20px", "20px", "20px", 0]}>
            <Image src="./images/homepage.png" alt="" width="100%" maxH="400px" objectFit="contain"
              borderRadius="20px"
            />
          </Flex>
        </Flex>
        <SimpleGrid minChildWidth="20rem" spacing="30px">
          <Box bg="#FDFDFF" p="2rem  4rem">
            ...
            <Text fontWeight="regular" color="#a2a2ad" mt="40px" fontSize="15px">Use Metamask, Wallet Connect or Coinbase to enter marketplace</Text>
          </Box>
          <Box bg="#FDFDFF" p="2rem  4rem">
          ...
          <Box bg="#FDFDFF" p="2rem  4rem">
            ...
            <Text fontWeight="regular" color="#a2a2ad" mt="40px" fontSize="15px">Only 1.75% per transaction to sell NFTs</Text>
          </Box>
          <Box bg="#FDFDFF" p="2rem  4rem">
